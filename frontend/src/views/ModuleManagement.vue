    ...
    <div class="flex-1 flex flex-col gap-6 w-full pb-12 min-w-0">
      ...
      <div class="grid grid-cols-12 gap-6">
        <div class="col-span-12 grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div class="bg-surface-container-low border border-outline-variant p-4 rounded-lg shadow-glow">
            <p class="text-[10px] text-on-surface-variant uppercase font-bold tracking-widest">{{ t('standby') }}</p>
          ...
          <div class="bg-surface-container-low border border-outline-variant p-4 rounded-lg border-error/30 shadow-glow">
            <p class="text-[10px] text-error uppercase font-bold tracking-widest">{{ t('warning') }}</p>
        ...
        <div class="col-span-12 lg:col-span-8 bg-surface-container-low border border-outline-variant rounded-xl overflow-hidden shadow-glow">
          <div class="p-4 border-b border-outline-variant bg-surface-container-high">
            <div class="flex items-center justify-between w-full">
              ...
              <div class="flex items-center gap-2">
                ...
                <button class="px-2 py-0.5 rounded bg-primary text-on-primary-container text-[10px] font-bold">{{ t('all') }}</button>
                <button class="px-2 py-0.5 rounded bg-surface-variant text-on-surface-variant text-[10px] font-bold hover:text-on-surface">{{ t('active').toUpperCase() }}</button>
                <button class="px-2 py-0.5 rounded bg-surface-variant text-on-surface-variant text-[10px] font-bold hover:text-on-surface">{{ t('warning').toUpperCase() }}</button>
              </div>
            </div>
          </div>
          ...
          <div class="px-4 py-2 bg-primary/5 border-b border-outline-variant/30 flex items-center justify-between">
            <div class="flex items-center gap-2">
              <span class="text-xs font-bold text-primary">2 {{ t('selected') }}</span>
              <div class="h-4 w-px bg-outline-variant/30 mx-2" />
              <button class="text-[10px] font-bold uppercase tracking-wider text-on-surface hover:text-primary transition-colors">{{ t('restartSelected') }}</button>
              <button class="text-[10px] font-bold uppercase tracking-wider text-error hover:opacity-80 transition-colors">{{ t('stopSelected') }}</button>
            </div>
          ...
          <table class="w-full text-left border-collapse">
            <thead class="bg-surface-container-highest border-b border-outline-variant/30">
              <tr class="text-[11px] font-bold text-on-surface-variant uppercase tracking-widest">
                ...
                <th class="px-4 py-3">{{ t('uptime') }}</th>
            ...
            <tbody class="divide-y divide-outline-variant/10 font-mono text-xs">
              <tr class="bg-primary/5">
                ...
                <td class="px-4 py-4 text-tertiary font-bold">{{ t('active') }}</td>
              ...
              <tr>
                ...
                <td class="px-4 py-4 text-error font-bold">{{ t('warning') }}</td>
        ...
        <div class="col-span-12 lg:col-span-4 space-y-4">
          <div class="bg-surface-container-low border border-primary/30 p-5 rounded-xl shadow-glow">
            <h3 class="font-bold text-sm text-primary mb-4 flex items-center gap-2">
              <span class="material-symbols-outlined">settings_input_component</span> {{ t('coreEngineDetails') }}
            </h3>

            <div class="space-y-5">
              <div class="space-y-1.5">
                <div class="flex justify-between text-xs">
                  <span class="text-on-surface-variant">{{ t('cpuUsage') }}</span>
              ...
              <div class="space-y-1.5">
                <div class="flex justify-between text-xs">
                  <span class="text-on-surface-variant">{{ t('memory') }}</span>
              ...
              <div class="space-y-3 pt-3 border-t border-outline-variant/30">
                <div class="flex flex-col gap-1">
                  <label class="text-[10px] font-bold text-on-surface-variant uppercase">{{ t('logLevel') }}</label>
                ...
                <div class="flex flex-col gap-1">
                  <label class="text-[10px] font-bold text-on-surface-variant uppercase">{{ t('dependencies') }}</label>
