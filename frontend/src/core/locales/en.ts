export const en = {
  ...
  notificationSettingsSub: 'Manage explicit module subscriptions and severity thresholds',
  ...
  quietHoursSub: 'Schedule automatic sound and push muting (except critical errors)',
  quietHoursStart: 'From',
  quietHoursEnd: 'To',
  quietHoursEnabled: 'Enable Quiet Hours',
  quietHoursDays: 'Recurrence',
  quietHoursEveryday: 'Every day',
  quietHoursWeekdays: 'Weekdays (Mon-Fri)',
  quietHoursWeekends: 'Weekends (Sat-Sun)',
  ...
  moduleUnsubscribed: 'Not Subscribed',
  minSeverity: 'Severity threshold',
  severityAll: 'All events (Info+)',
  ...
  graphView: 'Topology Graph',
  eventsSurface: 'Events Surface (Pub/Sub)',
  ...
  moduleDeps: 'Mandatory Dependencies',
  moduleOptionalDeps: 'Optional Dependencies',
  depActive: 'Active',
