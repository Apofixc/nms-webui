    ...
    try:
        while True:
            ...
            widget_data = {
                ...
                "title": "tuyaWidgetTitle",
                "metrics": [
                    {"id": "total", "label": "tuyaTotalDevices", "value": total, "unit": "шт", "status": "info", "icon": "devices"},
                    {"id": "online", "label": "tuyaOnlineDevices", "value": online_count, "unit": "шт", "status": "ok", "icon": "check_circle"},
                    {"id": "offline", "label": "tuyaOfflineDevices", "value": offline_count, "unit": "шт", "status": "warning" if offline_count > 0 else "info", "icon": "error"},
                ],
