    ...
    "stream": {
        ...
        "playback_udp": {
            ...
            "backends": {
                ...
                "astra": {"bin": "/opt/nms-webui/bin_module/astra4.4.182"},
                "webrtc": {},
            },
        },
    },
...
def get_stream_playback_udp_backend_options() -> dict[str, dict[str, Any]]:
    ...
    return {
        ...
        "astra": {
            "bin": (b.get("astra") or {}).get("bin") or (default.get("astra") or {}).get("bin") or "astra",
        },
